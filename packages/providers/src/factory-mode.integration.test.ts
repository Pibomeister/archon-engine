...
// POSIX-only: the case turns on an anonymous file descriptor with nlink 0 and mode 0o600, and on
// inheriting that descriptor as fd 3 in a child. Windows has no equivalent — it reports mode
// 0o666 and does not pass numbered descriptors this way.
test.skipIf(process.platform === 'win32')(
  'actual registry consumes a one-shot FD and broker lease without forwarding its capability',
  async () => {
